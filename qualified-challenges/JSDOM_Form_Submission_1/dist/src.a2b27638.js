...
function validateForm(formData) {
  var errors = {}; // check if name was entered
...
var submitHandler = function submitHandler(event) {
  ...
  var form = event.target; //console.log(form);
  ...
  var searchTerm = formData.get("searchTerm").toLowerCase(); //console.log(`searchTerm ${searchTerm}`);
  ...
  h2List.forEach(function (h2) {
    var article = h2.closest("article");
    var h2InnerHTML = h2.innerHTML.toLowerCase();
