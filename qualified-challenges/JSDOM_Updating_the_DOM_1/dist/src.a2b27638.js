...
function addHeadings() {
  ...
  var articles = document.querySelector(".articles"); //go to each article element,
  // grap the text and add the h2 element with the text

  var _iterator = _createForOfIteratorHelper(article),
      _step;
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      element = element.remove(innerText);
      var h2Element = document.createElement("h2");
      h2Element.innerText = innerText;
      articles.appendChild(h2Element);
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function styleTutorialsAndArticles() {// loop through all article
